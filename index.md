...
runs every cranlint check against a package and returns a single tibble
of findings. Here it’s pointed at a tiny example package with two
easy-to-miss issues: a one-sentence `Description` field, and a hardcoded
[`set.seed()`](https://rdrr.io/r/base/Random.html) call inside a
function.
